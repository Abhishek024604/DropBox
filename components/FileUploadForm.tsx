    ...
    <div className="space-y-4">
        ...
        {!file ? (
          <div className="space-y-3">
            ...
            <div>
              ...
              <p className="text-xs text-default-500 mt-1">Images and Videos up to 10MB</p>
            </div>
            <Input
              type="file"
              ref={fileInputRef}
      ...
      <div className="bg-default-100/5 p-4 rounded-lg">
        ...
        <ul className="text-xs text-default-600 space-y-1">
          <li>• Images and Videos are private and only visible to you</li>
          <li>• Supported formats: JPG, PNG, GIF, WebP, mp4</li>
